...
/**
 * This is tests for transaction feature.
 */
public class TestControllerTransactStocks {
  ...
  public void init() {
    ...
    StringBuilder mainMenuString;
    DataIO mockDataIO;
    PriceProvider mockPriceProvider;
    List<Portfolio> persisted;
    List<Stock> masterList;
    ...
    Mockito.when(mockDataIO.readMasterStockList()).thenReturn(masterList);


    persisted = Arrays.asList(
    ...
    Mockito.when(mockDataIO.readPersistedPortfolios()).thenReturn(persisted);
  ...
  public void testTransaction() {
    ...
    Mockito.when(mockModel.getAllPortfolios()).thenReturn(Arrays.asList("flexible|2022-11-17|10" +
            ".0"));
